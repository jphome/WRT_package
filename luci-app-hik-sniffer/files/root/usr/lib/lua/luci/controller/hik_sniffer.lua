...
module("luci.controller.hik_sniffer", package.seeall)
...
function index()
	...
	entry({"admin", "network", "hik_sniffer"}, call("hik_sniffer"), _("HIK Sniffer"), 100)
end

function hik_sniffer()
	luci.sys.call("hik_sniffer >/dev/null 2>&1")
	luci.template.render("hik_sniffer")
end
